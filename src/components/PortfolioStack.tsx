...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    year: '2026',
    tabLabel: 'O2 REALTY // VP-04',
    color: '#00e5ff',
    overview: 'High-production cinematic video production, architectural storytelling, and commercial milestone films for premier property consultants, O2 Realty. We direct and produce high-fidelity video campaigns and vertical reels that turn high-net-worth viewers into qualified property investors.',
    challenge: 'In the luxury real estate consulting sector, static imagery and conventional brochures fail to capture physical scale, luxury ambiance, and corporate stature. O2 Realty required immersive 4K video assets and milestone celebration reels that establish investor trust and showcase brand authority.',
    research: 'Analyzed media consumption behaviors among high-net-worth property investors in regional hubs. Found that 78% of luxury property seekers make direct contact after watching cinematic video walkthroughs and founder-led milestone stories on Instagram and digital channels.',
    strategy: 'Engineered an end-to-end video production protocol: narrative scripting, 4K multi-cam ground and drone cinematography, precision sound engineering, dynamic kinetic typography, and vertical reel formatting optimized for high algorithmic distribution.',
    execution: 'Shot, directed, and edited cinematic brand films and corporate milestone celebration reels highlighting O2 Realty\'s growth, team credibility, and client partnerships, paired with targeted social distribution.',
    results: 'Substantial organic reel retention, elevated brand prestige in regional real estate, and direct inbound investor inquiries generated through video storytelling.',
    link: 'https://www.instagram.com/p/DdLekRjDCzN/',
    galleryImages: [
      'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600"><rect width="800" height="600" fill="%230b0b0d" rx="8"/><rect x="20" y="20" width="760" height="560" fill="%23121214" rx="8" stroke="%23222" stroke-width="1"/><rect x="50" y="50" width="700" height="394" fill="%2309090b" rx="6" stroke="%2300e5ff" stroke-width="1" stroke-opacity="0.3"/><path d="M 70,80 L 70,65 L 85,65" stroke="%2300e5ff" stroke-width="2" fill="none"/><path d="M 730,80 L 730,65 L 715,65" stroke="%2300e5ff" stroke-width="2" fill="none"/><path d="M 70,414 L 70,429 L 85,429" stroke="%2300e5ff" stroke-width="2" fill="none"/><path d="M 730,414 L 730,429 L 715,429" stroke="%2300e5ff" stroke-width="2" fill="none"/><circle cx="400" cy="247" r="28" fill="none" stroke="%2300e5ff" stroke-width="1" stroke-dasharray="4 4" opacity="0.4"/><line x1="390" y1="247" x2="410" y2="247" stroke="%2300e5ff" stroke-width="1.5"/><line x1="400" y1="237" x2="400" y2="257" stroke="%2300e5ff" stroke-width="1.5"/><path d="M 280,380 L 280,180 L 360,140 L 440,180 L 440,380 Z" fill="none" stroke="%2300e5ff" stroke-width="1.2" opacity="0.5"/><line x1="280" y1="220" x2="440" y2="220" stroke="%2300e5ff" stroke-width="0.8" opacity="0.3"/><line x1="280" y1="260" x2="440" y2="260" stroke="%2300e5ff" stroke-width="0.8" opacity="0.3"/><line x1="280" y1="300" x2="440" y2="300" stroke="%2300e5ff" stroke-width="0.8" opacity="0.3"/><line x1="280" y1="340" x2="440" y2="340" stroke="%2300e5ff" stroke-width="0.8" opacity="0.3"/><path d="M 440,380 L 440,240 L 520,200 L 520,380 Z" fill="none" stroke="%2300e5ff" stroke-width="1" opacity="0.4"/><circle cx="80" cy="85" r="5" fill="%23ef4444"/><text x="92" y="89" fill="%23ef4444" font-family="monospace" font-size="11" font-weight="bold">REC [00:02:14:18]</text><text x="350" y="89" fill="%2300e5ff" font-family="monospace" font-size="11">4K DCI · 60 FPS</text><text x="630" y="89" fill="%23888" font-family="monospace" font-size="11">ISO 800 · F/2.8</text><text x="80" y="420" fill="%23aaa" font-family="monospace" font-size="10">O2 REALTY // MILESTONE PRODUCTION</text><text x="620" y="420" fill="%2300e5ff" font-family="monospace" font-size="10">RAW 12-BIT</text><rect x="50" y="465" width="700" height="75" fill="%2318181b" rx="4" stroke="%232a2a30" stroke-width="1"/><rect x="70" y="475" width="160" height="24" fill="%2300e5ff" fill-opacity="0.2" rx="2" stroke="%2300e5ff" stroke-width="0.8"/><text x="80" y="491" fill="%2300e5ff" font-family="monospace" font-size="9">V1: DRONE_SWEEP.MOV</text><rect x="240" y="475" width="220" height="24" fill="%230055ff" fill-opacity="0.2" rx="2" stroke="%230055ff" stroke-width="0.8"/><text x="250" y="491" fill="%230055ff" font-family="monospace" font-size="9">V2: INTERIOR_GIMBAL.MOV</text><rect x="470" y="475" width="200" height="24" fill="%2310b981" fill-opacity="0.2" rx="2" stroke="%2310b981" stroke-width="0.8"/><text x="480" y="491" fill="%2310b981" font-family="monospace" font-size="9">V3: FOUNDER_INTERVIEW.MOV</text><text x="50" y="565" fill="%23888" font-family="sans-serif" font-size="9" letter-spacing="1">VIDEO PRODUCTION PIPELINE // O2 REALTY ARCHIVE</text></svg>',
      'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600"><rect width="800" height="600" fill="%230b0b0d" rx="8"/><rect x="250" y="40" width="300" height="520" fill="%23121214" rx="14" stroke="%2300e5ff" stroke-width="1" stroke-opacity="0.4"/><circle cx="280" cy="70" r="16" fill="%2300e5ff" fill-opacity="0.2" stroke="%2300e5ff" stroke-width="1"/><text x="274" y="74" fill="%2300e5ff" font-family="sans-serif" font-size="10" font-weight="bold">O2</text><text x="304" y="70" fill="%23fff" font-family="sans-serif" font-size="11" font-weight="bold">o2realtyconsultants</text><text x="304" y="82" fill="%23888" font-family="sans-serif" font-size="8">Jaipur, India • Reel</text><rect x="260" y="96" width="280" height="340" fill="%231a1a20" rx="8"/><circle cx="400" cy="260" r="32" fill="rgba(0, 229, 255, 0.15)" stroke="%2300e5ff" stroke-width="2"/><path d="M 393,246 L 413,260 L 393,274 Z" fill="%2300e5ff"/><text x="400" y="320" fill="%23fff" font-family="sans-serif" font-size="13" font-weight="bold" text-anchor="middle">CELEBRATING THE JOURNEY</text><text x="400" y="340" fill="%2300e5ff" font-family="monospace" font-size="9" text-anchor="middle">O2 REALTY MILESTONES</text><text x="270" y="460" fill="%23fff" font-family="sans-serif" font-size="10" font-weight="bold">o2realtyconsultants</text><text x="270" y="476" fill="%23ddd" font-family="sans-serif" font-size="8.5">Celebrating the journey of O2 Realty — built on trust...</text><text x="270" y="492" fill="%2300e5ff" font-family="sans-serif" font-size="8">%23RealEstate %23Jaipur %23O2Realty %23VideoProduction</text><rect x="260" y="520" width="280" height="2" fill="rgba(255,255,255,0.2)"/><rect x="260" y="520" width="190" height="2" fill="%2300e5ff"/><text x="260" y="542" fill="%23888" font-family="sans-serif" font-size="8" letter-spacing="1">INSTAGRAM REEL // PRODUCTION_02</text></svg>',
      'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600"><rect width="800" height="600" fill="%230b0b0d" rx="8"/><rect x="30" y="30" width="740" height="540" fill="%23121214" rx="8" stroke="%23222" stroke-width="1"/><text x="50" y="65" fill="%2300e5ff" font-family="monospace" font-size="11" font-weight="bold">COLOR GRADING &amp; MASTERING SUITE // O2 REALTY</text><rect x="50" y="85" width="330" height="220" fill="%2309090c" rx="4" stroke="%23222" stroke-width="1"/><text x="65" y="108" fill="%23888" font-family="monospace" font-size="9">RGB PARADE // 10-BIT 4:2:2</text><path d="M 70,260 Q 90,140 120,200 T 170,160" fill="none" stroke="%23ef4444" stroke-width="1.5" opacity="0.8"/><path d="M 180,260 Q 200,130 230,190 T 280,150" fill="none" stroke="%2310b981" stroke-width="1.5" opacity="0.8"/><path d="M 290,260 Q 310,120 340,180 T 370,140" fill="none" stroke="%2300e5ff" stroke-width="1.5" opacity="0.8"/><rect x="410" y="85" width="340" height="220" fill="%2309090c" rx="4" stroke="%23222" stroke-width="1"/><text x="425" y="108" fill="%23888" font-family="monospace" font-size="9">COLOR BALANCE // TEAL-GOLD PALETTE</text><circle cx="580" cy="195" r="70" fill="none" stroke="%23333" stroke-width="1"/><circle cx="580" cy="195" r="40" fill="none" stroke="%23222" stroke-width="1"/><line x1="510" y1="195" x2="650" y2="195" stroke="%23333" stroke-width="1"/><line x1="580" y1="125" x2="580" y2="265" stroke="%23333" stroke-width="1"/><circle cx="595" cy="180" r="5" fill="%2300e5ff"/><rect x="50" y="330" width="700" height="200" fill="%230a0a0d" rx="6" stroke="%23222" stroke-width="1"/><text x="70" y="365" fill="%23fff" font-family="sans-serif" font-size="12" font-weight="bold">PRODUCTION DELIVERABLES CHECKLIST</text><line x1="70" y1="380" x2="730" y2="380" stroke="%231f1f25" stroke-width="1"/><text x="70" y="415" fill="%2300e5ff" font-family="monospace" font-size="10">✓ 4K 60FPS MASTER COMMERCIAL CUT (16:9)</text><text x="70" y="445" fill="%2300e5ff" font-family="monospace" font-size="10">✓ 9:16 VERTICAL SOCIAL REEL CAMPAIGNS</text><text x="70" y="475" fill="%2300e5ff" font-family="monospace" font-size="10">✓ DRONE ARCHITECTURAL ELEVATION SEQUENCE</text><text x="70" y="505" fill="%2300e5ff" font-family="monospace" font-size="10">✓ HIGH FIDELITY SPATIAL SOUND MASTERING</text><text x="50" y="565" fill="%23888" font-family="sans-serif" font-size="9" letter-spacing="1">CINEMATOGRAPHY SUITE // POST_03</text></svg>'
    ]
  },
  {
    id: 'harith-rasoi',
    ...
    year: '2026',
    tabLabel: 'HARITH RASOI // SM-05',
    color: '#10b981',
    overview: 'Complete social media strategy, culinary video production, and high-engagement community management for Harith Rasoi. We handle their digital presence end-to-end, producing viral culinary reels, mouth-watering food photography, and localized campaigns that drive active restaurant footfall.',
    challenge: 'Standing out in a competitive dining ecosystem demands continuous culinary storytelling and mouth-watering visual appeal. Harith Rasoi needed consistent social branding, high-energy food prep reels, and an active community protocol that translates digital engagement into hungry walk-in diners.',
    research: 'Audited regional culinary social dynamics. Discovered that food enthusiasts make dining decisions based on high-sensory video content—sizzling tawa close-ups, authentic prep processes, and real diner reactions—far more than static promotional posts.',
    strategy: 'Engineered a weekly social media publishing engine consisting of dynamic short-form food reels, interactive culinary stories, customer spotlight highlights, and festival-driven promotional activations.',
    execution: 'Captured high-definition culinary photography and reels, designed branded social carousels, orchestrated community engagement protocols, and deployed targeted local awareness campaigns.',
    results: 'Steady follower growth, viral reach across local food communities, and high direct walk-in attribution from Instagram promotions.',
    link: 'https://www.instagram.com/harit_rasoi7/',
    galleryImages: [
      'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600"><rect width="800" height="600" fill="%230b0b0d" rx="8"/><rect x="250" y="40" width="300" height="520" fill="%23121214" rx="12" stroke="%2310b981" stroke-width="1" stroke-opacity="0.4"/><circle cx="285" cy="75" r="20" fill="%2310b981" fill-opacity="0.2" stroke="%2310b981" stroke-width="1.5"/><text x="277" y="80" fill="%2310b981" font-family="sans-serif" font-size="11" font-weight="bold">HR</text><text x="320" y="68" fill="%23fff" font-family="sans-serif" font-size="12" font-weight="bold">harit_rasoi7</text><text x="320" y="84" fill="%23888" font-family="sans-serif" font-size="9">Harit Rasoi • 156 Posts</text><text x="268" y="115" fill="%23eee" font-family="sans-serif" font-size="9" font-weight="bold">Harith Rasoi | Authentic Dining</text><text x="268" y="128" fill="%23aaa" font-family="sans-serif" font-size="8">Curating fresh culinary experiences &amp; rich Indian flavors 🌿</text><rect x="260" y="200" width="85" height="85" fill="%231a1a20" rx="3"/><circle cx="302" cy="242" r="18" fill="none" stroke="%2310b981" stroke-width="1" stroke-dasharray="2 2"/><text x="302" y="246" fill="%2310b981" font-family="sans-serif" font-size="8" text-anchor="middle">DISH 01</text><rect x="355" y="200" width="85" height="85" fill="%231a1a20" rx="3"/><circle cx="397" cy="242" r="18" fill="none" stroke="%2310b981" stroke-width="1" stroke-dasharray="2 2"/><text x="397" y="246" fill="%2310b981" font-family="sans-serif" font-size="8" text-anchor="middle">REEL 02</text><rect x="450" y="200" width="85" height="85" fill="%231a1a20" rx="3"/><circle cx="492" cy="242" r="18" fill="none" stroke="%2310b981" stroke-width="1" stroke-dasharray="2 2"/><text x="492" y="246" fill="%2310b981" font-family="sans-serif" font-size="8" text-anchor="middle">KITCHEN</text><text x="268" y="440" fill="%2310b981" font-family="monospace" font-size="9" font-weight="bold">MANAGED BY HH STUDIO</text><text x="268" y="460" fill="%23888" font-family="sans-serif" font-size="8">Social content calendar · High-engagement community protocol</text><text x="260" y="540" fill="%23888" font-family="sans-serif" font-size="8" letter-spacing="1">INSTAGRAM PROTOCOL // FEED_01</text></svg>',
      'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600"><rect width="800" height="600" fill="%230b0b0d" rx="8"/><rect x="250" y="40" width="300" height="520" fill="%2316161c" rx="12" stroke="%23222" stroke-width="1"/><rect x="260" y="50" width="280" height="420" fill="%23101814" rx="8"/><circle cx="400" cy="220" r="34" fill="rgba(16, 185, 129, 0.2)" stroke="%2310b981" stroke-width="2"/><path d="M 393,205 L 415,220 L 393,235 Z" fill="%2310b981"/><text x="400" y="280" fill="%23fff" font-family="sans-serif" font-size="14" font-weight="bold" text-anchor="middle">CHEF\'S SPECIAL SIZZLE</text><text x="400" y="300" fill="%2310b981" font-family="monospace" font-size="9" text-anchor="middle">HARITH RASOI SIGNATURES</text><text x="270" y="420" fill="%23fff" font-family="sans-serif" font-size="10" font-weight="bold">harit_rasoi7</text><text x="270" y="438" fill="%23eee" font-family="sans-serif" font-size="8.5">Fresh flavors crafted daily at Harith Rasoi ✨</text><rect x="260" y="480" width="280" height="2" fill="rgba(255,255,255,0.2)"/><rect x="260" y="480" width="210" height="2" fill="%2310b981"/><text x="260" y="540" fill="%23888" font-family="sans-serif" font-size="8" letter-spacing="1">INSTAGRAM REEL // VIRAL_REEL_02</text></svg>',
      'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600"><rect width="800" height="600" fill="%230b0b0d" rx="8"/><rect x="30" y="30" width="740" height="540" fill="%23121214" rx="8" stroke="%23222" stroke-width="1"/><text x="50" y="65" fill="%2310b981" font-family="monospace" font-size="11" font-weight="bold">HARITH RASOI // SOCIAL GROWTH &amp; AUDIENCE TELEMETRY</text><rect x="50" y="85" width="700" height="240" fill="%2309090c" rx="4" stroke="%23222" stroke-width="1"/><text x="70" y="115" fill="%23888" font-family="monospace" font-size="9">LOCAL REACH &amp; DINING INTENT CONVERSION</text><line x1="70" y1="140" x2="720" y2="140" stroke="%2318181f" stroke-width="1"/><line x1="70" y1="180" x2="720" y2="180" stroke="%2318181f" stroke-width="1"/><line x1="70" y1="220" x2="720" y2="220" stroke="%2318181f" stroke-width="1"/><line x1="70" y1="260" x2="720" y2="260" stroke="%2318181f" stroke-width="1"/><path d="M 90,270 Q 200,250 300,210 T 500,160 T 700,120" fill="none" stroke="%2310b981" stroke-width="2.5"/><circle cx="700" cy="120" r="5" fill="%2310b981"/><text x="640" y="110" fill="%2310b981" font-family="monospace" font-size="10" font-weight="bold">+320% REACH</text><rect x="50" y="350" width="220" height="180" fill="%230a0a0d" rx="6" stroke="%23222" stroke-width="1"/><text x="70" y="380" fill="%23888" font-family="monospace" font-size="9">MONTHLY IMPRESSIONS</text><text x="70" y="420" fill="%23fff" font-family="sans-serif" font-size="28" font-weight="bold">250K+</text><text x="70" y="450" fill="%2310b981" font-family="monospace" font-size="9">Organic + Local Reels</text><rect x="290" y="350" width="220" height="180" fill="%230a0a0d" rx="6" stroke="%23222" stroke-width="1"/><text x="310" y="380" fill="%23888" font-family="monospace" font-size="9">ENGAGEMENT RATE</text><text x="310" y="420" fill="%23fff" font-family="sans-serif" font-size="28" font-weight="bold">8.4%</text><text x="310" y="450" fill="%2310b981" font-family="monospace" font-size="9">3.2x Industry Average</text><rect x="530" y="350" width="220" height="180" fill="%230a0a0d" rx="6" stroke="%23222" stroke-width="1"/><text x="550" y="380" fill="%23888" font-family="monospace" font-size="9">FOOTFALL CONVERSION</text><text x="550" y="420" fill="%23fff" font-family="sans-serif" font-size="28" font-weight="bold">High</text><text x="550" y="450" fill="%2310b981" font-family="monospace" font-size="9">Direct Walk-ins via IG</text></svg>'
    ]
  }
];
        ...
        <div className="stack-viewport">
          <div className="folders-container">
            {projectsList.map((project, index) => {
              ...
              const baseRotation = total > 1 
                ? -6 + (index / (total - 1)) * 12 
                : 0;
              const baseY = index * 20;
              const scale = 0.92 + (index / Math.max(total - 1, 1)) * 0.08;
                ...
                >
                  ...
                  <div 
                    ...
                    style={{
                      ...
                      left: !isMobile ? `${Math.min(index * 92, 380)}px` : '0px'
                    }}
                  >
            ...
            <div className="case-study-scroll-wrapper" data-lenis-prevent>
              ...
              <div className="case-study-top-bar glassmorphism">
                ...
                <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
                  ...
                  >
                    <span>
                      {activeProject.id === 'o2-realty' ? "WATCH VIDEO REEL" : activeProject.id === 'harith-rasoi' ? "VIEW INSTAGRAM" : activeProject.link ? "VISIT PROJECT" : "LAUNCH ENGINE"}
                    </span>
                      ...
                      <div className="schematic-drawing">
                        ...
                        <div className="wirebox" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px 10px', minHeight: '120px' }}>
                          ...
                          <span className="schem-label" style={{ marginBottom: '12px' }}>
                            ...
                            {activeProject.id === 'o2-realty' && "VIDEO PRODUCTION REEL"}
                            {activeProject.id === 'harith-rasoi' && "SOCIAL MEDIA ENGINE"}
                          ...
                          {activeProject.link && (
                            ...
                            >
                              <span>
                                ...
                                {activeProject.id === 'o2-realty' && "Watch Video Reel"}
                                {activeProject.id === 'harith-rasoi' && "Instagram Profile"}
                              </span>
