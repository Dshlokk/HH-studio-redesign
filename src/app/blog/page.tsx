...
const ARTICLES: Article[] = [
  {
    ...
    category: 'Branding',
    date: 'Dec 2024',
    title: 'Why Most Rebrands Fail Before the Logo Is Even Designed',
    excerpt: 'The most common cause of rebrand failure isn\'t weak design — it\'s a strategy vacuum. Here\'s what rigorous brand architecture actually looks like before any visual work begins.',
    readTime: '6 min'
  },
  {
    ...
    date: 'Nov 2024',
    title: 'The Content Compounding Effect: Why Consistency Beats Virality',
    excerpt: 'Chasing viral moments is a losing game. The brands winning at content are building engines, not one-offs. Here\'s how to build a content system that compounds over 12 months.',
    readTime: '5 min'
  },
  {
    ...
    date: 'Nov 2024',
    title: 'Performance Creative: The Brief That Actually Improves Your ROAS',
    excerpt: 'Most performance briefs optimize for click-through rate. The best ones start with the customer\'s belief system. Here\'s how to write briefs that unlock better creative and better returns.',
    readTime: '8 min'
  }
];
